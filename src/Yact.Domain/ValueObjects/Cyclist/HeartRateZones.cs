...
public record HeartRateZones
{
    ...
    private HeartRateZones(IDictionary<int, Zone> values)
    {
        Values = values;
    }

    /// <summary>
    /// Factory to create a HearRateZones Value Object.
    /// </summary>
    ...
    /// </remarks>
    public static HeartRateZones Create(IDictionary<int, Zone> values)
    {
        // Check count
        ...
        return new HeartRateZones(values);
    }
}
